...
#define ___________________NAV_L1__________________       KC_BRID,         KC_BRIU,         TD(TD_SNIP),     SNIP_PASTE,      SNIP_TOGGLE
#define ___________________NAV_L2__________________       KC_LGUI,         KC_LOPT,         KC_LCTL,         KC_LSFT,         KC_F12
#define ___________________NAV_L3__________________       KC_VOLD,         KC_VOLU,         KC_MUTE,         ZOOM_OUT,        ZOOM_IN
#define ______________NAV_THUMB_LEFT_______________       _______,         ZOOM_RESET
